...
17. Thêm chương trình hỗ trợ mới ngoài 6 policy hiện có — cụ thể NIC, NAFOSTED, Quỹ Đổi mới công nghệ quốc gia mà người dùng nêu làm ví dụ — cần crawl + xác minh nguồn như cách 23 nguồn hiện tại đã làm trước khi đưa vào `data/policies.json`, chưa làm vì rủi ro sai thông tin nếu vội trong thời gian ngắn.
18. Thu thập biểu mẫu gốc thật (Word/PDF/Excel do từng chương trình công bố) + metadata (áp dụng chương trình nào, còn hiệu lực không) — chưa có bất kỳ file nào trong `data/`; đây là điều kiện để "Auto Form Filling" thật sự điền vào form gốc thay vì chỉ soạn văn bản tóm tắt như `/api/grant-docx` hiện tại.
