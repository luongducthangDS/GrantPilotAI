...
{"name": "...", "tax_code": "...", "province": "...", "industry": "...", "business_line": "...", "employees": 0, "revenue_bil": 0, "capital_bil": 0, "representative": "..."}
...
export async function POST(request: Request) {
  ...
  try {
    ...
    for (const key of ["employees", "revenue_bil", "capital_bil"]) {
